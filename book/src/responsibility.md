...
| `DirectoryFormat` (plain directory mount)     | `image-delta-core::formats::directory`    |
| `Qcow2Format` (qemu-nbd mount, feature-gated) | `image-delta-core::formats::qcow2`        |
...
2. **`impl ImageFormat`** (optional) — if images use a format other than plain
